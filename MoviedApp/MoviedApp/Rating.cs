...
{
    //COPY http://www.codeproject.com/Articles/9117/C-Star-Rating-Control Andrey Butov, 20 Dec 2004

    public class Rating : System.Windows.Forms.Control
    {
        public Rating()
        {
        ...
        protected void DrawStar(Graphics g, Rectangle rect, int starAreaIndex)
        {
            ...
            {
                fillBrush = new SolidBrush(m_hoverColor);
            }
        ...
        protected Color m_hoverColor = Color.White;
